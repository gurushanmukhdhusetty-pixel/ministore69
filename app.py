...
# Custom High-End Styling Matrix
st.markdown("""
    <style>
    .stApp {
    ...
    /* FLOATING SUPPORT BUTTON - FIXED BOTTOM-RIGHT POSITION */
...
# ==========================================
# 2. DEFINITIVE STORE CATALOG DATA
# ==========================================
PRODUCTS = [
...
# Track cart transactions across page scopes natively
if "cart" not in st.session_state:
    st.session_state.cart = {}

# ==========================================
# 3. SIDEBAR ENGINE (Filters & Cart Overview)
# ==========================================
...
# ==========================================
# 4. PRODUCT DISPLAY SHOWCASE GRID
# ==========================================
...
# ==========================================
# 5. FLOATING MULTIPAGE NAVIGATION ANCHOR
# ==========================================
# Standardized low-case file layout naming conversion to navigate tabs instantly
st.markdown("""
    <div class="floating-chat-anchor">
        <a href="/Support_Chatbot" target="_self" class="floating-chat-element">
            💬 Launch AI Support
        </a>
    </div>
""", unsafe_allow_html=True)
